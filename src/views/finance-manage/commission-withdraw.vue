  ...
  <div class="mixin-components-container">
      ...
      <el-table :data="list" border fit highlight-current-row style="width: 100%">
        ...
        <el-table-column label="操作" align="center" width="180">
          <template slot-scope="scope">
            ...
            <el-button v-if="scope.row.status==0 && btnAry.findIndex(x => x.id == '129')!=-1" type="primary" size="mini" @click="checkList(scope.row)">审核</el-button>
    ...
    <el-dialog :title="detailTitle" :visible.sync="detailVisible" class="center-dialog" width="90%">
      <el-tabs v-model="activeName">
        ...
        <el-tab-pane label="日志明细" name="second">
          <el-table :data="dataDetail" border style="width: 100%;margin-top:30px" >
            <el-table-column label="ID" prop="id" align="center" width="80"/>
            <el-table-column label="操作人" align="center" prop="total_amount" width="200" />
            ...
            <el-table-column label="时间" align="center" prop="total_amount"  width="160"/>
            <el-table-column label="描述" align="center" prop="hotel_amount"  />
          </el-table>
...
import { getWithdrawList, getWithdrawDetailList, orderWithdrawListExcel,getMerchList,getMerchCheck,getMerchPayment } from '@/api/finance-manage/commission-withdraw'
